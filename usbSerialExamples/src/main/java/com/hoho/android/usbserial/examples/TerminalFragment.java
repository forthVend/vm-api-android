...
import com.forth.vm.vmc.driver.UsbSerialDriver;
import com.forth.vm.vmc.driver.UsbSerialPort;
import com.forth.vm.vmc.driver.UsbSerialProber;
import com.forth.vm.vmc.util.SerialInputOutputManager;
...
public class TerminalFragment extends Fragment implements SerialInputOutputManager.Listener {
    ...
    private ControlLines controlLines1;
    ...
    private void connect() {
        ...
        try {
            ...
            status(deviceId + " : " + portNum + " : " + baudRate + " : " + withIoManager);
        } catch (Exception e) {
